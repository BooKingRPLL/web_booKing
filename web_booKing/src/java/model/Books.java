...
public class Books implements java.io.Serializable {
    ...
    public Books(String bookId, Authors authors, String title, String synopsis, Integer year, Integer page, Integer price, Integer qty, Set<Genres> genreses, Set<TransLists> transListses) {
        this.bookId = bookId;
